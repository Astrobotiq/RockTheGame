...
namespace New_Scripts.Player.States
{
    ...
    public class WallClimbingState : IPlayerState
    {
        ...
        public void UpdateState()
        {
            ...
            {
                context.TransitionToState(new AirborneState(context, Vector2.zero,true, 0f, 0.5f));
            }
        ...
        private void CheckInputTransitions()
        {
            ...
            if (context.Input.IsJumpPressed)
            {
                ...
                context.TransitionToState(new AirborneState(context, jumpVelocity,true, 0f, 0.2f));
                return;
            }
            ...
            {
                context.TransitionToState(new AirborneState(context, Vector2.zero,true, 0f, 0.2f));
            }
        }
