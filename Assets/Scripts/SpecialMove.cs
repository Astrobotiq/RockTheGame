...
public class SpecialMove : MonoBehaviour
{
    ...
    {
        if (leftSpring.connectedBody == null && rightSpring.connectedBody != null ||
            leftSpring.connectedBody != null && rightSpring.connectedBody == null)
        {
            ...
            {
                if (Mathf.Abs(rb.linearVelocity.x) < 40)
                {
            ...
            {
                if (Mathf.Abs(rb.linearVelocity.x) < 20)
                {
